...
class GPTDLayer(nn.Module):
    ...
    def __init__(self, size, dropout,
        ...
        # Register self.mask as a buffer in GPTD/TransformerDecoderLayer, so
        # it gets GPTD/TransformerDecoderLayer's cuda behavior automatically.
...
class GPTD(nn.Module):
    ...
    def __init__(self, num_layers, hidden_size, attn_type,
        ...
        # Build GPTD/TransformerDecoder.
        self.transformer_layers = nn.ModuleList(
            [GPTDLayer(hidden_size, dropout)
             for _ in range(num_layers)])

        # GPTD/TransformerDecoder has its own attention mechanism.
    ...
    def forward(self, tgt, memory_bank, state, memory_lengths=None):
        ...
        """
        # CHECKS
        assert isinstance(state, GPTDState)
        ...
        # Run the forward pass of the GPTD/TransformerDecoder.
    ...
    def init_decoder_state(self, src, memory_bank, enc_hidden):
        return GPTDState(src)


class GPTDState(DecoderState):
