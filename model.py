...
class EncoderDecoder(nn.Module):
    ...
    # def __init__(self, decoder, src_embed, tgt_embed, generator):
    ...
    def forward(self, src, tgt, src_mask, tgt_mask):
        ...
        # output = self.decoder(self.tgt_embed(tgt), self.src_embed(src), src_mask, tgt_mask)
        return output


def make_model(src_vocab, tgt_vocab, N=2, d_model=512, d_ff=2048, h=1, dropout=0.1):
...
print(list(tmp_model.state_dict()))
